/**
  ...
  ******************************************************************************
  */
#ifndef AI_NETWORKK_H
#define AI_NETWORKK_H

#include "networkk_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_NETWORKK_MODEL_NAME          "networkk"
#define AI_NETWORKK_ORIGIN_MODEL_NAME   "autoencoder_model"

/******************************************************************************/
#define AI_NETWORKK_ACTIVATIONS_ALIGNMENT   (4)
#define AI_NETWORKK_INPUTS_IN_ACTIVATIONS   (4)
#define AI_NETWORKK_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_NETWORKK_IN_NUM        (1)

AI_DEPRECATED
#define AI_NETWORKK_IN \
  ai_networkk_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORKK_IN_SIZE { \
  AI_NETWORKK_IN_1_SIZE, \
}
#define AI_NETWORKK_IN_SIZE_BYTES { \
  AI_NETWORKK_IN_1_SIZE_BYTES, \
}
#define AI_NETWORKK_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_NETWORKK_IN_1_CHANNEL     (1)
#define AI_NETWORKK_IN_1_SIZE        (1)
#define AI_NETWORKK_IN_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_NETWORKK_OUT_NUM       (1)

AI_DEPRECATED
#define AI_NETWORKK_OUT \
  ai_networkk_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORKK_OUT_SIZE { \
  AI_NETWORKK_OUT_1_SIZE, \
}
#define AI_NETWORKK_OUT_SIZE_BYTES { \
  AI_NETWORKK_OUT_1_SIZE_BYTES, \
}
#define AI_NETWORKK_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_NETWORKK_OUT_1_CHANNEL     (1)
#define AI_NETWORKK_OUT_1_SIZE        (1)
#define AI_NETWORKK_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_NETWORKK_N_NODES (7)
 ...
 * @ref ai_networkk_create. Both the activations memory buffer 
 ...
 * using @ref ai_networkk_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_networkk_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_networkk_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_NETWORKK_*
 * defines into file @ref networkk.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
